...
| 静音/取消静音 | 静音/取消静音 |
| 启动应用 | 启动 [应用名称] |
| 在 Microsoft Edge | 打开 [网站名称] (例如"open bing.com")  |
| 拍照 | 拍照 |
| 开始录制视频 | 开始录制 |
| 停止录制视频 | 停止录制 |
| 显示时间 | 现在 几点钟？ |
...
需要说出想要使用的标点的名称。 例如，你可能会说"你好 **，逗号** 问号 **是什么。"**
...
有时，拼写出电子邮件地址等内容会很有帮助。 例如，若要指示 example@outlook.com ，你会说"outlook dot-com 上的 E X A M P L E"。
