...
如果要以更高的分辨率玩游戏，可以随时在 "SteamVR-> 设置-> 应用程序" 窗口中调整应用程序分辨率滑块。 **请注意** ，使用更高的分辨率乘数时，可能会希望游戏在您的 PC 上施加更大的压力。 如果增加乘数并查看下降的性能，则会将此滑块重新调整为默认级别，并重新启动游戏以确保更改生效。 ![调整应用程序分辨率](images/SteamVR_Settings_Applications.png)
...
加入：
  ...
  3. 单击 " **测试** 版" 选项卡。
  4. 选择 **"beta-公共 beta"** ，并单击 " **关闭** " 以确认。 请注意，"beta 访问代码" 字段应留空。
...
加入：
  ...
  3. 单击 " **测试** 版" 选项卡。
  4. 选择 **"beta-公共 beta"** ，并单击 " **关闭** " 以确认。  请注意，"beta 访问代码" 字段应留空。 ![切换到 SteamVR 的 "属性" 对话框中的 "SteamVR beta"。](images/steamvr-beta.png)
...
4. 某些游戏已报告为以50% 速度运行，或延迟延迟 (lag) 。 请通过下面的 [Windows 反馈中心](filing-feedback.md) 说明报告这些游戏。
