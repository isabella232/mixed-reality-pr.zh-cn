...
### <a name="using-hp-reverb-g2-controllers"></a>使用 HP 回音 G2 控制器

如果使用的是 HP 回音 G2 控制器，请参阅下表中的按钮和轴 Id。

<table>
<tr>
<th rowspan="2"><a href="https://docs.unity3d.com/ScriptReference/XR.CommonUsages.html">输入 </th><th colspan="2">公共 Unity Api</a><br /> (GetButton/GetAxis)  </th><th rowspan="2">HP 回音</a></th>
</tr><tr>
<th> 左手 </th><th> 右手</th>
</tr><tr>
<td> Primary2DAxis </td><td> 轴 1 (X) /轴 2 (Y)  </td><td> 轴 4 (X) /轴 5 (Y)  </td><td> 控制</td>
</tr><tr>
<td> 按下触发器 </td><td> 轴9 </td><td> 轴10 </td><td> 索引触发器</td>
</tr><tr>
<td> 调整 </td><td> 轴11d </td><td> 轴12 </td><td> 抓握触发器</td>
</tr><tr>
<td> PrimaryButton 按下 </td><td> 按钮2 </td><td> 按钮0 </td><td> 按下菜单按钮</td>
</tr><tr>
<td> SecondaryButton 按下 </td><td> 按钮3 </td><td> 按钮1 </td><td> A/X 按钮</td>
</tr><tr>
<td> GripButton </td><td> 按钮4 </td><td> 按钮5 </td><td> 抓握触发器</td>
</tr><tr>
<td> TriggerButton </td><td> 按钮14 </td><td> 按钮15 </td><td> 索引触发器</td>
</tr><tr>
</tr>
</table>
...
请注意，这代表控制器的手柄姿势 (其中用户保存控制器) ，这对于渲染用户的剑或压力或控制器本身的模型非常有用。
