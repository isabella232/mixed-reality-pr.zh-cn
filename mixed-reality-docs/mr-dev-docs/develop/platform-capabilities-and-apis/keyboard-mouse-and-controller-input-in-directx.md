...
对于沉浸式桌面耳机，可以通过实现 **CoreTextEditContext** 来支持 Windows 通过沉浸式视图呈现的虚拟键盘。 这样，Windows 便可以了解你自己的应用呈现的文本框的状态，因此虚拟键盘可以正确地参与到文本中。
...
重新编译和重新部署。 请注意，单击鼠标后，将会在具有蓝牙鼠标的沉浸式耳机或 HoloLens 中重新定位该立方体。
