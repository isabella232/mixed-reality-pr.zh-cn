---
title: 参与说明
description: 了解如何使用新版 Markdown 在 docs.microsoft.com 平台上参与GitHub混合现实开发人员文档。
author: mattwojo
ms.author: mattwoj
ms.date: 01/11/2021
ms.topic: article
...
ms.locfileid: "115216312"
---
# <a name="contributing-to-mixed-reality-developer-documentation"></a>参与混合现实开发人员文档

欢迎使用 [混合现实开发人员文档的公共存储库](https://github.com/MicrosoftDocs/mixed-reality/tree/master/mixed-reality-docs)！ 在此存储库创建或编辑的任何文章 **都将对公众可见。** 

混合现实文档现已在 docs.microsoft.com 平台上提供，该平台使用GitHub Markdown 和 Markdig 功能。 在此存储库编辑的内容将格式化为显示在 中的样式化页面 https://docs.microsoft.com/windows/mixed-reality 。 

本页介绍参与和链接 Markdown 基础知识的基本步骤和指南。 感谢你的发布内容！
...
- 为 [Github 帐户 创建强密码](https://github.com/settings/admin)。
...
需要将图像上传到存储库的"mixed-reality-docs/images"文件夹，然后在文章中适当地引用它们。 图像将自动以全尺寸显示，这意味着大型图像将填满文章的整个宽度。 建议在上传图像之前预先调整图像大小。 建议宽度介于600到700像素之间，不过，如果它是密集屏幕截图或屏幕截图的小部分，则应调整大小。
