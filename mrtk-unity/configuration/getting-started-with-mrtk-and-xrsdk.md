...
XR SDK 是 unity [2019.3 和更高版本中的 unity 新 XR 管道](https://blogs.unity3d.com/2020/01/24/unity-xr-platform-updates/)。 在 Unity 2019 中，它可替代现有的 XR 管道。 在 Unity 2020 中，它是 Unity 中唯一的 XR 管道。
...
若要将现有配置文件迁移到 XR SDK，应更新以下服务和数据访问接口。
::: moniker range=">= mrtkunity-2021-05"
你将能够在 Unity 2019 中的 XR SDK 选项卡下，或在 Unity 2020 + 的主/仅视图中看到新的数据提供程序，其中旧 XR 不存在。
